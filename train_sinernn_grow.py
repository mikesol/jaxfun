...
if __name__ == "__main__":
    ...
    run = Experiment(
        ...
        project_name="jax-sine-rnn-grow",
    )
    ## defaults
    _config = {}
    _config["seed"] = 42
    ...
    _config["epochs"] = 2**7
    _config["window"] = 2**13
    _config["window_start"] = 2**5
    _config["window_growth"] = 2**1
    ...
    _config["skip"] = False
    _config["levels"] = 2**3
    _config["end_features"] = 2**6
    _config["end_levels"] = 2**3
    ...
    for epoch in range(config.epochs):
        ...
        for batch_ix, batch in tqdm(
            ...
            o = jit_do_inference(state, input[:, :window_to_use, :])
