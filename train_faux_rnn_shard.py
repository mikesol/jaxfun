...
if __name__ == "__main__":
    ...
    jit_train_step = partial(
        jax.jit, in_shardings=(state_sharding, x_sharding, None, None), out_shardings=state_sharding
    )(train_step)

    jit_compute_loss = partial(
        jax.jit, in_shardings=(state_sharding, x_sharding, None, None), out_shardings=x_sharding
    )(compute_loss)
